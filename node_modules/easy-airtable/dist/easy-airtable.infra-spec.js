...
const easy_airtable_table_1 = require("./easy-airtable.table");
describe('AirtableServiceTable', () => {
    ...
    const TEST_CONFIG = {
        ...
        tableId: 'tblDQoKVItulKlmkW',
    };
    beforeEach(() => {
        repository = easy_airtable_table_1.EasyAirtableTable.fromConfig(TEST_CONFIG);
    });
    afterEach(async () => {
    ...
    it('추가된 레코드의 정보를 통해 레코드를 찾을 수 있다.', async () => {
        ...
        expect(exist === null || exist === void 0 ? void 0 : exist.fields).toMatchObject({
            NAME: TEST_NAME,
            TEL: TEST_TEL,
        });
        expect(exist === null || exist === void 0 ? void 0 : exist.id).toBe(record.id);
    });
