...
class EasyAirtableTable {
    ...
    findBy(where, options) {
        return this.table.select(Object.assign({ filterByFormula: this.policy.mapJsonToFormula(where) }, options)).all();
    }
    findAll(options) {
        return this.table.select(Object.assign({}, options)).all();
    }
    async findOneBy(where, options) {
        const records = await this.table.select(Object.assign({ filterByFormula: this.policy.mapJsonToFormula(where) }, options)).firstPage();
...
exports.EasyAirtableTable = EasyAirtableTable;
